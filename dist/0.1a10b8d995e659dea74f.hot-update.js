...
let ProductServiceImpl = class ProductServiceImpl {
    ...
    async createProductAdditionalImages(additionalImages, productId) {
        ...
        return default_response_1.DefaultResponse.responseWithData(common_1.HttpStatus.OK, "작업 성공!", new product_edit_image_response_dto_1.ProductEditImageResponseDto(await this.imageStorageProcessors(parseInt(id), additionalImages, "additional")));
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bec10b32f8f744cb0cd6")
/******/ })();
/******/ 
/******/ }
;