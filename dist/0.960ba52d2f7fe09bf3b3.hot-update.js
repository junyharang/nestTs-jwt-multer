...
let ProductServiceImpl = class ProductServiceImpl {
    ...
    deleteOriginalImages(imageDivision, productMainImageUrl) {
        ...
        if (imageDivision === "main") {
            originalImageDirectoryPath = path.join(__dirname, "uploads", "product", "images", "main", imageName);
        }
        else if (imageDivision === "additional") {
            originalImageDirectoryPath = path.join(__dirname, "uploads", "product", "images", "additional", imageName);
        }
        else {
            originalImageDirectoryPath = path.join(__dirname, "uploads", "product", "images", "detail", imageName);
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("366704220fc6b8949b7d")
/******/ })();
/******/ 
/******/ }
;