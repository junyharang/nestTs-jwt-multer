...
let UserProductServiceImpl = class UserProductServiceImpl {
    ...
    async viewImage(userTokenRequestDto, urn, response) {
        ...
        await this.parsingImageDivision(fileUrn);
        const fileNameMatch = fileUrn(/\/([^\/]+)$/);
    ...
    async parsingImageDivision(fileUrn) {
        ...
        await this.checkImageExistence(fileUrn, regExpMatchArray[1]);
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ef8d44aa74e86e2d586d")
/******/ })();
/******/ 
/******/ }
;