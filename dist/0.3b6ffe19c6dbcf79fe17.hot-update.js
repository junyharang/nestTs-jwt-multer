...
let AuthenticationServiceImpl = class AuthenticationServiceImpl {
    ...
    async signOut(id, response) {
        ...
        return default_response_1.DefaultResponse.responseWithData(common_1.HttpStatus.UNAUTHORIZED, "로그아웃 성공!", response.cookie("jwt", "", { maxAge: 0 }));
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("dfe99e6265898a6affcb")
/******/ })();
/******/ 
/******/ }
;